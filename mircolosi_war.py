...
pygame.display.set_caption("Mircolosi War")
...
playerimg = pygame.image.load(path.join(img_dir,"foreground_res.png")).convert()
...
boss1img = pygame.image.load(path.join(img_dir,"boss_iocchi.png")).convert()
...
boss2img = pygame.image.load(path.join(img_dir,"boss_giorgio.png")).convert()
boss3img = pygame.image.load(path.join(img_dir,"boss_nardi.png")).convert()
...
#********game*******
def intro():
    pygame.mixer.music.load(path.join(snd_dir, 'shooting-star.mp3'))
    ...
    while True:
        ...
        label("Mircolosi War",width/2-150,200,60,red)
